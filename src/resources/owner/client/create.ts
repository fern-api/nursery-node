...
export const Error = {
  ...
  _unknown: (fetcherError: core.Fetcher.Error): FernNursery.owner.create.Error._Unknown => {
    const valueWithoutVisit = fetcherError as unknown as Omit<FernNursery.owner.create.Error._Unknown, "_visit">;
    return core.addNonEnumerableProperty(valueWithoutVisit, "_visit", function <
      _Result
    >(this: FernNursery.owner.create.Error._Unknown, visitor: FernNursery.owner.create.Error._Visitor<_Result>) {
      return FernNursery.owner.create.Error._visit(this, visitor);
    });
  },
