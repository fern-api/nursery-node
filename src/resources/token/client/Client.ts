...
export class Client {
  ...
  public async create(request: FernNurseryApi.CreateTokenRequest): Promise<FernNurseryApi.token.create.Response> {
  ...
  public async getTokenMetadata(
    request: FernNurseryApi.GetTokenMetadataRequest
  ...
  public async revokeTokenById(
    request: FernNurseryApi.token.revokeTokenById.Request
  ): Promise<FernNurseryApi.token.revokeTokenById.Response> {
    const response = await core.fetcher({
  ...
  public async revokeToken(
    request: FernNurseryApi.RevokeTokenRequest
  ): Promise<FernNurseryApi.token.revokeToken.Response> {
    const response = await core.fetcher({
